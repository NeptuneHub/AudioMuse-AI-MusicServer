...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Modern dark theme inspired by Spotify and YouTube Music
        'dark': {
          900: '#0a0a0a',  // Deepest black
          800: '#121212',  // Main background
          750: '#181818',  // Card background
          700: '#1e1e1e',  // Hover state
          600: '#282828',  // Border/divider
          500: '#333333',  // Lighter elements
        },
        'accent': {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
          300: '#5eead4',
          400: '#2dd4bf',  // Primary accent (teal/cyan)
          500: '#14b8a6',
          600: '#0d9488',
          700: '#0f766e',
          800: '#115e59',
